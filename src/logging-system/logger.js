...
var infoStream = fs.createWriteStream('/var/log/servicorp/info.txt');
...
// file if needed.
var errorStream = fs.createWriteStream('/var/log/servicorp/error.txt');
...
var debugStream = fs.createWriteStream('/var/log/servicorp/debug.txt');
