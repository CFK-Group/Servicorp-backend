            ...
            connection.query('INSERT INTO srv_formulario (latitud, longitud, tipo_formulario_id, usuario_id) VALUES (?)', [values], (err, result) => {
                ...
                switch (req.tipo_formulario_id) {
                    ...
                    values = [
                        ...
                        [formulario_id, req.tipo_formulario_id, req.usuario_id, 560, req.resp_16],
                        [formulario_id, req.tipo_formulario_id, req.usuario_id, 561, req.resp_17],
                        [formulario_id, req.tipo_formulario_id, req.usuario_id, 562, req.resp_18],
                        [formulario_id, req.tipo_formulario_id, req.usuario_id, 563, req.resp_19],
                        [formulario_id, req.tipo_formulario_id, req.usuario_id, 564, req.resp_20],
                        [formulario_id, req.tipo_formulario_id, req.usuario_id, 565, req.resp_21],
                        [formulario_id, req.tipo_formulario_id, req.usuario_id, 566, req.resp_22],
                        [formulario_id, req.tipo_formulario_id, req.usuario_id, 567, req.resp_23],
                        [formulario_id, req.tipo_formulario_id, req.usuario_id, 568, req.resp_24],
                        [formulario_id, req.tipo_formulario_id, req.usuario_id, 569, req.resp_25],
                        [formulario_id, req.tipo_formulario_id, req.usuario_id, 570, req.resp_26],
